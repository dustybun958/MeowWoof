      ...
      <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="dark">
          <a href="{{ route('index') }}" class="logo">
            <img src="{{ asset('admin/img/kaiadmin/meowwoof.svg') }}" alt="navbar brand" class="navbar-brand" height="20" />
          </a>
      ...
      <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item {{ Route::is('admin.stories.*') || (Route::is('stories.*') && !Route::is('stories.draft')) ? 'active' : '' }}">
              <a data-bs-toggle="collapse" href="#stories">
                <i class="fas fa-newspaper"></i>
                <p>Stories</p>
                <span class="caret"></span>
              </a>
              <div class="collapse {{ Route::is('admin.stories.*') || (Route::is('stories.*') && !Route::is('stories.draft')) ? 'show' : '' }}" id="stories">
                <ul class="nav nav-collapse">
                  @if (auth()->user()->hasRole('Super Admin'))
                  <li>
                    <a href="{{ route('admin.stories.manage') }}">
            ...
            @endif
            @if (auth()->user()->hasRole('Writer') || auth()->user()->hasRole('Super Admin'))
            <li class="nav-item {{ Route::is('admin.users.*') || Route::is('stories.draft') ? 'active' : '' }}">
              <a data-bs-toggle="collapse" href="#users">
                <i class="fas fa-users-cog"></i>
                <p>Users</p>
                <span class="caret"></span>
              </a>
              <div class="collapse {{ Route::is('admin.users.*') || Route::is('stories.draft') ? 'show' : '' }}" id="users">
                <ul class="nav nav-collapse">
                  @if (auth()->user()->hasRole('Super Admin'))
                  <li>
            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
              ...
              <li class="nav-item topbar-user dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="avatar-sm">
                    <img src="{{ auth()->user()->image ? asset('storage/images/' . auth()->user()->image) : asset('img/default.jpeg') }}" alt="Profile Picture" class="avatar-img rounded-circle" />
                  </div>
                ...
                <ul class="dropdown-menu dropdown-user animated fadeIn">
                  <div class="dropdown-user-scroll scrollbar-outer">
                    <li>
                      <div class="user-box">
                        <div class="avatar-lg">
                          <img src="{{ auth()->user()->image ? asset('storage/images/' . auth()->user()->image) : asset('img/default.jpeg') }}" alt="Profile Picture" class="avatar-img rounded" />
                        </div>
                        <div class="u-text">
