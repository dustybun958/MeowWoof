      ...
      <div class="container px-0">
        <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
          <div class="top-info flex-grow-0">
            ...
            @foreach (\App\Models\Stories::where('status', 'Accept')->withCount('likes')->orderBy('likes_count', 'desc')->take(1)->get() as $stories)
            <div class="overflow-hidden" style="width: 735px">
              <div id="note" class="ps-2">
                <img src="{{ $stories->image ? asset('storage/images/' . $stories->image) : asset('img/noimg.jpg') }}" class="img-fluid rounded-circle border border-3 border-primary me-2" style="width: 30px; height: 30px" alt="" />
                <a href="{{ route('stories.show', $stories->id) }}">
      ...
      <div class="container px-0">
        <nav class="navbar navbar-light navbar-expand-xl">
          <a href="{{ route('index') }}" class="navbar-brand d-block">
            <img src="{{ asset('admin/img/kaiadmin/meowwoof.svg') }}" alt="" class="img-fluid" style="max-width: 200px;">
          </a>
            ...
            <div class="scroll-container">
              ...
              <div class="scroll-content">
                <div class="navbar-nav mx-lg-4 border-top" style="white-space: nowrap; max-width: 60vw;">
                  ...
                  <a href="{{ route('stories.viewCategory', $categories->id) }}" class="nav-item nav-link mt-2">{{ $categories->name }}</a>
                  @endforeach
                </div>
              </div>
      ...
      <div class="row g-5">
        <div class="col-lg-6 col-xl-3">
          <div class="footer-item-1">
            ...
            <div class="d-flex line-h">
              ...
              <a class="btn btn-light btn-md-square rounded-circle" href="#"><i class="fab fa-github text-dark"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-xl-3">
          <div class="footer-item-2">
            @foreach (\App\Models\Stories::where('status', 'Accept')->orderBy('created_at', 'desc')->take(1)->get() as $stories)
            <div class="d-flex flex-column mb-4">
              <h4 class="mb-4 text-white">Recent Stories</h4>
              <a href="{{ route('stories.viewCategory', $stories->category->id) }}">
                <div class="d-flex align-items-center">
                  <div class="rounded-circle border border-2 border-primary overflow-hidden">
                    <img src="{{ $stories->image ? asset('storage/images/' . $stories->image) : asset('img/noimg.jpg') }}" class="img-zoomin img-fluid rounded-circle w-100" alt="" style="width: 100px; height: 100px; object-fit: cover;" />
                  </div>
                  <div class="d-flex flex-column ps-4">
                    <p class="text-uppercase text-white mb-3">{{ $stories->category->name }}</p>
                    <a href="{{ route('stories.show', $stories->id) }}" class="h6 text-white">
                      {{ $stories->title }}
                    </a>
            ...
            @endforeach
            @foreach (\App\Models\Stories::where('status', 'Accept')->orderBy('created_at', 'desc')->skip(1)->take(1)->get() as $stories)
        ...
        <div class="col-lg-6 col-xl-3">
          <div class="d-flex flex-column text-start footer-item-3">
            ...
            <a class="btn-link text-white" href="{{ route('stories.viewCategory', $categories->id) }}"><i class="fas fa-angle-right text-white me-2"></i> {{ $categories->name }}</a>
            @endforeach
          </div>
        </div>
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="row g-2">
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict1.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict2.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict3.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict4.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict5.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
              <div class="col-4">
                <div class="rounded overflow-hidden">
                  <img src="{{ asset('img/pict6.jpeg') }}" class="img-zoomin img-fluid rounded w-100" alt="" />
                </div>
              </div>
            </div>
          </div>
