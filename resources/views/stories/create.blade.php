        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <div class="card-title">Create Stories</div>
            </div>
            <div class="card-body">
              <div class="row">
                <form action="{{ route('stories.store') }}" method="POST" enctype="multipart/form-data" id="form">
                  ...
                  <div class="col-12 mx-auto">
                    <div class="form-group row">
                      ...
                      <div class="col-12">
                        <input type="text" class="form-control input-full" id="inlineinput" placeholder="Enter Input" name="title" />
                      </div>
                    </div>
                    ...
                    <div class="card-footer mt-3 d-flex justify-content-start">
                      <button type="submit" class="btn btn-success me-1" id="CKsubmitButton">Submit</button>
